...
#
# Названия обезличены намеренно: перечислять реальные лизинговые компании
# партнёрами, когда договора нет, — заявление о существующих организациях.
# Заказчик впишет своих.
LEASING_PARTNERS = [
    ("Лизинговая компания «Восток»", "спецпрограмма на технику Komatsu"),
    ("Лизинговая компания «Амур»", "аванс от 10% для постоянных клиентов"),
    ("Дальневосточный лизинг", "решение за один день"),
    ("Промышленный лизинг", "работа с бюджетными организациями"),
]

# Способы доставки. Для Дальнего Востока это вопрос первого разговора.
DELIVERY_OPTIONS = [
    (
        "Перегон своим ходом",
        "Машина идёт на объект самостоятельно в сопровождении "
        "нашего водителя. Подходит для колёсной техники на расстояниях до 500 км.",
        "1–3 дня",
        "в пределах Хабаровского края",
    ),
    (
        "Автовоз",
        "Перевозка тралом или низкорамной платформой. Основной способ для "
        "гусеничной техники и машин, которым нельзя на дороги общего пользования.",
        "3–7 дней",
        "негабарит согласуется отдельно",
    ),
    (
        "Железная дорога",
        "Отправка платформой со станции Хабаровск. Выгодна на "
        "расстояниях от 1000 км и для партий из нескольких машин.",
        "10–20 дней",
        "до станции назначения",
    ),
    (
        "Морем",
        "Отгрузка через порты Ванино и Советская Гавань — для Сахалина, "
        "Магадана, Камчатки и Чукотки.",
        "по расписанию судов",
        "до портов Ванино и Советская Гавань",
    ),
]

# Отзывы клиентов. Демонстрационные: компании и люди вымышленные.
REVIEWS = [
    (
        ...
        "Хабаровск",
        5,
        "Брали экскаватор в марте, привезли за три недели вместо обещанного месяца. "
        "Сервис выезжал на объект дважды по гарантии, вопросов нет.",
        "ekskavator",
    ),
    (
        ...
        5,
        "Работаем третий год по запчастям. Ходовую и фильтры держат на складе, "
        "по срочным позициям привозят за неделю. Счета выставляют в день заявки.",
        None,
    ),
    (
        "Белов Андрей Николаевич",
        "директор",
        "ООО «Ванинопорт-Сервис»",
        "Ванино",
        4,
        "Погрузчик взяли в лизинг, оформили быстро. Единственное — ждали поставку "
        "дольше, чем рассчитывали, но предупредили заранее.",
        "pogruzchik",
    ),
    (
        "Тимофеев Олег Валерьевич",
        "главный инженер",
        "ООО «Севердорстрой»",
        "Хабаровск",
        5,
        "Заказывали ТО катка с выездом на объект. Приехали в назначенный день, "
        "сделали за смену. Отчёт по маслам прислали на почту.",
        None,
    ),
    (
        "Гусева Марина Александровна",
        "руководитель отдела закупок",
        "АО «Приамурская горная компания»",
        "Хабаровск",
        5,
        "Ценим за то, что не пропадают после продажи. По любому вопросу отвечает "
        "закреплённый менеджер, а не общий телефон.",
        None,
    ),
]

# Рейтинги на внешних площадках. Цифры демонстрационные.
# Карточки хабаровского филиала. В Google у него отзывов нет, поэтому такой
# площадки в списке тоже нет. Оценки проставлены ориентировочно — перед показом
# клиенту их нужно сверить с площадкой, дата сверки видна на странице.
REVIEW_SOURCES = [
    (
        "2gis",
        "4.4",
        17,
        "https://2gis.ru/khabarovsk/firm/70000001031919631/tab/reviews",
    ),
    (
        "yandex",
        "4.6",
        23,
        "https://yandex.ru/maps/org/modern_mashineri/92195781304/reviews/",
    ),
]

# Подборки по диапазонам характеристик — под запросы вида «экскаватор 20 тонн».
# (slug, заголовок, тип техники, код параметра, от, до, текст)
RANGE_LANDINGS = [
    (
        "ekskavatory-20-25-tonn",
        "Экскаваторы 20–25 тонн",
        "ekskavator",
        "operating_weight",
        20000,
        25000,
        "Экскаваторы эксплуатационной массой 20–25 тонн — самый ходовой класс на "
        "дорожных и строительных объектах Хабаровского края. Хватает вылета и "
        "глубины копания для котлованов и траншей, при этом машина перевозится "
        "обычным тралом без согласования негабарита.",
    ),
    (
        "ekskavatory-ot-30-tonn",
        "Экскаваторы от 30 тонн",
        "ekskavator",
        "operating_weight",
        30000,
        None,
        "Тяжёлые экскаваторы для карьеров, вскрышных работ и погрузки скальной "
        "породы. Подбираем под объём ковша и требуемую производительность, "
        "поставляем с гарантией и сервисным обслуживанием на объекте.",
    ),
    (
        "pogruzchiki-do-3-tonn",
        "Погрузчики до 3 тонн",
        "vilochnyy-pogruzchik",
        "lifting_capacity",
        None,
        3000,
        "Вилочные погрузчики грузоподъёмностью до трёх тонн — для складов, "
        "производственных цехов и портовых площадок. Компактные, проходят в "
        "стандартные ворота и работают в помещении.",
    ),
]
