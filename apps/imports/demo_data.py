...
# Оценка Google намеренно пустая: переносить её на свой сайт запрещено
# правилами сервиса, поэтому карточка показывается одной ссылкой.
REVIEW_SOURCES = [
    ("2gis", "4.4", 17, "https://2gis.ru/khabarovsk"),
    ("yandex", "4.6", 23, "https://yandex.ru/maps"),
    ("google", None, 0, "https://maps.google.com"),
]
